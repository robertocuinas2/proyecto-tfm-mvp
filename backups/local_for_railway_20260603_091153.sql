...
\restrict wbzMoFLIsJzR6wJi9R8mybmsVKBElHxyW5SF0jsf1PbUfiEB2qEzYEccb9VXeDO
...
ALTER TABLE IF EXISTS ONLY public.tratamientos_activos DROP CONSTRAINT IF EXISTS tratamientos_activos_prescrito_por_fkey;
ALTER TABLE IF EXISTS ONLY public.tratamientos_activos DROP CONSTRAINT IF EXISTS tratamientos_activos_evento_sanitario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tratamientos_activos DROP CONSTRAINT IF EXISTS tratamientos_activos_animal_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_recurrentes DROP CONSTRAINT IF EXISTS tareas_recurrentes_zona_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_recurrentes DROP CONSTRAINT IF EXISTS tareas_recurrentes_maquinaria_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_recurrentes DROP CONSTRAINT IF EXISTS tareas_recurrentes_catalogo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_ejecuciones DROP CONSTRAINT IF EXISTS tareas_ejecuciones_zona_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_ejecuciones DROP CONSTRAINT IF EXISTS tareas_ejecuciones_recurrente_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_ejecuciones DROP CONSTRAINT IF EXISTS tareas_ejecuciones_maquinaria_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_ejecuciones DROP CONSTRAINT IF EXISTS tareas_ejecuciones_empleado_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tareas_ejecuciones DROP CONSTRAINT IF EXISTS tareas_ejecuciones_catalogo_id_fkey;
ALTER TABLE IF EXISTS ONLY public.resumenes_relevo DROP CONSTRAINT IF EXISTS resumenes_relevo_turno_saliente_id_fkey;
ALTER TABLE IF EXISTS ONLY public.resumenes_relevo DROP CONSTRAINT IF EXISTS resumenes_relevo_turno_entrante_id_fkey;
ALTER TABLE IF EXISTS ONLY public.resumenes_relevo DROP CONSTRAINT IF EXISTS resumenes_relevo_confirmado_por_fkey;
ALTER TABLE IF EXISTS ONLY public.pedidos DROP CONSTRAINT IF EXISTS pedidos_solicitante_id_fkey;
ALTER TABLE IF EXISTS ONLY public.maquinaria DROP CONSTRAINT IF EXISTS maquinaria_zona_id_fkey;
ALTER TABLE IF EXISTS ONLY public.lecturas_robot_ordeno DROP CONSTRAINT IF EXISTS lecturas_robot_ordeno_robot_id_fkey;
ALTER TABLE IF EXISTS ONLY public.lecturas_robot_ordeno DROP CONSTRAINT IF EXISTS lecturas_robot_ordeno_lactacion_id_fkey;
ALTER TABLE IF EXISTS ONLY public.lecturas_robot_ordeno DROP CONSTRAINT IF EXISTS lecturas_robot_ordeno_animal_id_fkey;
ALTER TABLE IF EXISTS ONLY public.lecturas_carro_mezclador DROP CONSTRAINT IF EXISTS lecturas_carro_mezclador_operario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.lactaciones DROP CONSTRAINT IF EXISTS lactaciones_animal_id_fkey;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS incidencias_zona_id_fkey;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS incidencias_reportado_por_fkey;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS incidencias_maquinaria_id_fkey;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS incidencias_asignado_a_fkey;
ALTER TABLE IF EXISTS ONLY public.genomica DROP CONSTRAINT IF EXISTS genomica_animal_id_fkey;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS fk_incidencias_animal;
ALTER TABLE IF EXISTS ONLY public.empleados DROP CONSTRAINT IF EXISTS fk_empleados_zona_principal;
ALTER TABLE IF EXISTS ONLY public.eventos_sanitarios DROP CONSTRAINT IF EXISTS eventos_sanitarios_veterinario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.eventos_sanitarios_recria DROP CONSTRAINT IF EXISTS eventos_sanitarios_recria_empleado_id_fkey;
ALTER TABLE IF EXISTS ONLY public.eventos_sanitarios_recria DROP CONSTRAINT IF EXISTS eventos_sanitarios_recria_animal_id_fkey;
ALTER TABLE IF EXISTS ONLY public.eventos_sanitarios DROP CONSTRAINT IF EXISTS eventos_sanitarios_animal_id_fkey;
ALTER TABLE IF EXISTS ONLY public.eventos_reproductivos DROP CONSTRAINT IF EXISTS eventos_reproductivos_empleado_id_fkey;
ALTER TABLE IF EXISTS ONLY public.eventos_reproductivos DROP CONSTRAINT IF EXISTS eventos_reproductivos_animal_id_fkey;
ALTER TABLE IF EXISTS ONLY public.boxes_recria DROP CONSTRAINT IF EXISTS boxes_recria_ternero_id_fkey;
ALTER TABLE IF EXISTS ONLY public.asignaciones_turno DROP CONSTRAINT IF EXISTS asignaciones_turno_zona_id_fkey;
ALTER TABLE IF EXISTS ONLY public.asignaciones_turno DROP CONSTRAINT IF EXISTS asignaciones_turno_turno_id_fkey;
ALTER TABLE IF EXISTS ONLY public.asignaciones_turno DROP CONSTRAINT IF EXISTS asignaciones_turno_empleado_id_fkey;
ALTER TABLE IF EXISTS ONLY public.animales DROP CONSTRAINT IF EXISTS animales_zona_id_fkey;
ALTER TABLE IF EXISTS ONLY public.animales DROP CONSTRAINT IF EXISTS animales_madre_id_fkey;
ALTER TABLE IF EXISTS ONLY public.alertas DROP CONSTRAINT IF EXISTS alertas_zona_id_fkey;
ALTER TABLE IF EXISTS ONLY public.alertas DROP CONSTRAINT IF EXISTS alertas_umbral_id_fkey;
ALTER TABLE IF EXISTS ONLY public.alertas DROP CONSTRAINT IF EXISTS alertas_resuelta_por_fkey;
ALTER TABLE IF EXISTS ONLY public.alertas DROP CONSTRAINT IF EXISTS alertas_animal_id_fkey;
DROP TRIGGER IF EXISTS trg_audit_tratamientos_activos ON public.tratamientos_activos;
DROP TRIGGER IF EXISTS trg_audit_pedidos ON public.pedidos;
DROP TRIGGER IF EXISTS trg_audit_incidencias ON public.incidencias;
DROP TRIGGER IF EXISTS trg_audit_eventos_sanitarios ON public.eventos_sanitarios;
DROP TRIGGER IF EXISTS trg_audit_animales ON public.animales;
DROP INDEX IF EXISTS public.ix_usuarios_username;
DROP INDEX IF EXISTS public.ix_usuarios_role;
DROP INDEX IF EXISTS public.ix_usuarios_email;
DROP INDEX IF EXISTS public.ix_tareas_ejecuciones_empleado_id;
DROP INDEX IF EXISTS public.ix_empleados_zona_principal_id;
DROP INDEX IF EXISTS public.ix_core_treatments_animal_id;
DROP INDEX IF EXISTS public.ix_core_treatments_activo;
DROP INDEX IF EXISTS public.ix_core_tasks_zona_id;
DROP INDEX IF EXISTS public.ix_core_tasks_estado;
DROP INDEX IF EXISTS public.ix_core_machinery_estado;
DROP INDEX IF EXISTS public.ix_core_lactations_animal_id;
DROP INDEX IF EXISTS public.ix_core_incidents_zona_id;
DROP INDEX IF EXISTS public.ix_core_incidents_prioridad;
DROP INDEX IF EXISTS public.ix_core_incidents_estado;
DROP INDEX IF EXISTS public.ix_core_incidents_animal_id;
DROP INDEX IF EXISTS public.ix_core_employees_activo;
DROP INDEX IF EXISTS public.ix_core_animals_estado;
DROP INDEX IF EXISTS public.ix_core_animals_crotal_oficial;
DROP INDEX IF EXISTS public.ix_core_alerts_severidad;
DROP INDEX IF EXISTS public.ix_core_alerts_estado;
DROP INDEX IF EXISTS public.ix_core_alerts_animal_id;
DROP INDEX IF EXISTS public.ix_animales_zona_id;
DROP INDEX IF EXISTS public.idx_tratamientos_animal;
DROP INDEX IF EXISTS public.idx_tratamientos_activos;
DROP INDEX IF EXISTS public.idx_robot_ordeno_robot;
DROP INDEX IF EXISTS public.idx_robot_ordeno_animal;
DROP INDEX IF EXISTS public.idx_pedidos_ts;
DROP INDEX IF EXISTS public.idx_pedidos_estado;
DROP INDEX IF EXISTS public.idx_lactaciones_parto;
DROP INDEX IF EXISTS public.idx_lactaciones_animal;
DROP INDEX IF EXISTS public.idx_incidencias_zona;
DROP INDEX IF EXISTS public.idx_incidencias_tipo;
DROP INDEX IF EXISTS public.idx_incidencias_estado;
DROP INDEX IF EXISTS public.idx_incidencias_apertura;
DROP INDEX IF EXISTS public.idx_incidencias_animal;
DROP INDEX IF EXISTS public.idx_incidencias_acciones;
DROP INDEX IF EXISTS public.idx_genomica_animal;
DROP INDEX IF EXISTS public.idx_ev_sanitarios_tipo;
DROP INDEX IF EXISTS public.idx_ev_sanitarios_retirada;
DROP INDEX IF EXISTS public.idx_ev_sanitarios_animal;
DROP INDEX IF EXISTS public.idx_ev_repro_tipo;
DROP INDEX IF EXISTS public.idx_ev_repro_fecha;
DROP INDEX IF EXISTS public.idx_ev_repro_det;
DROP INDEX IF EXISTS public.idx_ev_repro_animal;
DROP INDEX IF EXISTS public.idx_ev_recria_fecha;
DROP INDEX IF EXISTS public.idx_ev_recria_animal;
DROP INDEX IF EXISTS public.idx_ejecuciones_zona;
DROP INDEX IF EXISTS public.idx_ejecuciones_planificada;
DROP INDEX IF EXISTS public.idx_ejecuciones_estado;
DROP INDEX IF EXISTS public.idx_ejecuciones_empleado;
DROP INDEX IF EXISTS public.idx_carro_mezcla;
DROP INDEX IF EXISTS public.idx_boxes_ternero;
DROP INDEX IF EXISTS public.idx_boxes_alertas;
DROP INDEX IF EXISTS public.idx_audit_ts;
DROP INDEX IF EXISTS public.idx_audit_tabla;
DROP INDEX IF EXISTS public.idx_audit_registro;
DROP INDEX IF EXISTS public.idx_animales_madre;
DROP INDEX IF EXISTS public.idx_animales_estado_repro;
DROP INDEX IF EXISTS public.idx_animales_estado;
DROP INDEX IF EXISTS public.idx_animales_crotal;
DROP INDEX IF EXISTS public.idx_alertas_nivel;
DROP INDEX IF EXISTS public.idx_alertas_animal;
DROP INDEX IF EXISTS public.idx_alertas_activas;
ALTER TABLE IF EXISTS ONLY public.zonas DROP CONSTRAINT IF EXISTS zonas_pkey;
ALTER TABLE IF EXISTS ONLY public.zonas DROP CONSTRAINT IF EXISTS zonas_nombre_key;
ALTER TABLE IF EXISTS ONLY public.zonas DROP CONSTRAINT IF EXISTS zonas_codigo_key;
...
ALTER TABLE IF EXISTS ONLY public.turnos DROP CONSTRAINT IF EXISTS turnos_fecha_tipo_turno_key;
ALTER TABLE IF EXISTS ONLY public.tratamientos_activos DROP CONSTRAINT IF EXISTS tratamientos_activos_pkey;
ALTER TABLE IF EXISTS ONLY public.tareas_recurrentes DROP CONSTRAINT IF EXISTS tareas_recurrentes_pkey;
ALTER TABLE IF EXISTS ONLY public.tareas_ejecuciones DROP CONSTRAINT IF EXISTS tareas_ejecuciones_pkey;
ALTER TABLE IF EXISTS ONLY public.tareas_catalogo DROP CONSTRAINT IF EXISTS tareas_catalogo_pkey;
ALTER TABLE IF EXISTS ONLY public.tareas_catalogo DROP CONSTRAINT IF EXISTS tareas_catalogo_codigo_key;
ALTER TABLE IF EXISTS ONLY public.schema_migrations DROP CONSTRAINT IF EXISTS schema_migrations_pkey;
ALTER TABLE IF EXISTS ONLY public.resumenes_relevo DROP CONSTRAINT IF EXISTS resumenes_relevo_pkey;
ALTER TABLE IF EXISTS ONLY public.pedidos DROP CONSTRAINT IF EXISTS pedidos_pkey;
ALTER TABLE IF EXISTS ONLY public.maquinaria DROP CONSTRAINT IF EXISTS maquinaria_pkey;
ALTER TABLE IF EXISTS ONLY public.maquinaria DROP CONSTRAINT IF EXISTS maquinaria_numero_serie_key;
ALTER TABLE IF EXISTS ONLY public.lecturas_robot_ordeno DROP CONSTRAINT IF EXISTS lecturas_robot_ordeno_pkey;
ALTER TABLE IF EXISTS ONLY public.lecturas_meteorologia DROP CONSTRAINT IF EXISTS lecturas_meteorologia_pkey;
ALTER TABLE IF EXISTS ONLY public.lecturas_carro_mezclador DROP CONSTRAINT IF EXISTS lecturas_carro_mezclador_pkey;
ALTER TABLE IF EXISTS ONLY public.lactaciones DROP CONSTRAINT IF EXISTS lactaciones_pkey;
ALTER TABLE IF EXISTS ONLY public.lactaciones DROP CONSTRAINT IF EXISTS lactaciones_animal_id_numero_key;
ALTER TABLE IF EXISTS ONLY public.incidencias DROP CONSTRAINT IF EXISTS incidencias_pkey;
ALTER TABLE IF EXISTS ONLY public.genomica DROP CONSTRAINT IF EXISTS genomica_pkey;
ALTER TABLE IF EXISTS ONLY public.eventos_sanitarios_recria DROP CONSTRAINT IF EXISTS eventos_sanitarios_recria_pkey;
ALTER TABLE IF EXISTS ONLY public.eventos_sanitarios DROP CONSTRAINT IF EXISTS eventos_sanitarios_pkey;
ALTER TABLE IF EXISTS ONLY public.eventos_reproductivos DROP CONSTRAINT IF EXISTS eventos_reproductivos_pkey;
ALTER TABLE IF EXISTS ONLY public.empleados DROP CONSTRAINT IF EXISTS empleados_pkey;
ALTER TABLE IF EXISTS ONLY public.datos_metereologicos DROP CONSTRAINT IF EXISTS datos_metereologicos_pkey;
ALTER TABLE IF EXISTS ONLY public.core_zones DROP CONSTRAINT IF EXISTS core_zones_pkey;
ALTER TABLE IF EXISTS ONLY public.core_zones DROP CONSTRAINT IF EXISTS core_zones_codigo_key;
ALTER TABLE IF EXISTS ONLY public.core_treatments DROP CONSTRAINT IF EXISTS core_treatments_pkey;
ALTER TABLE IF EXISTS ONLY public.core_tasks DROP CONSTRAINT IF EXISTS core_tasks_pkey;
ALTER TABLE IF EXISTS ONLY public.core_machinery DROP CONSTRAINT IF EXISTS core_machinery_pkey;
ALTER TABLE IF EXISTS ONLY public.core_lactations DROP CONSTRAINT IF EXISTS core_lactations_pkey;
ALTER TABLE IF EXISTS ONLY public.core_incidents DROP CONSTRAINT IF EXISTS core_incidents_pkey;
ALTER TABLE IF EXISTS ONLY public.core_employees DROP CONSTRAINT IF EXISTS core_employees_pkey;
ALTER TABLE IF EXISTS ONLY public.core_animals DROP CONSTRAINT IF EXISTS core_animals_pkey;
ALTER TABLE IF EXISTS ONLY public.core_animals DROP CONSTRAINT IF EXISTS core_animals_crotal_oficial_key;
ALTER TABLE IF EXISTS ONLY public.core_alerts DROP CONSTRAINT IF EXISTS core_alerts_pkey;
ALTER TABLE IF EXISTS ONLY public.boxes_recria DROP CONSTRAINT IF EXISTS boxes_recria_pkey;
ALTER TABLE IF EXISTS ONLY public.boxes_recria DROP CONSTRAINT IF EXISTS boxes_recria_box_numero_key;
ALTER TABLE IF EXISTS ONLY public.audit_log DROP CONSTRAINT IF EXISTS audit_log_pkey;
ALTER TABLE IF EXISTS ONLY public.asignaciones_turno DROP CONSTRAINT IF EXISTS asignaciones_turno_turno_id_empleado_id_key;
ALTER TABLE IF EXISTS ONLY public.asignaciones_turno DROP CONSTRAINT IF EXISTS asignaciones_turno_pkey;
ALTER TABLE IF EXISTS ONLY public.animales DROP CONSTRAINT IF EXISTS animales_pkey;
ALTER TABLE IF EXISTS ONLY public.animales DROP CONSTRAINT IF EXISTS animales_crotal_oficial_key;
ALTER TABLE IF EXISTS ONLY public.alertas_umbrales DROP CONSTRAINT IF EXISTS alertas_umbrales_pkey;
ALTER TABLE IF EXISTS ONLY public.alertas_umbrales DROP CONSTRAINT IF EXISTS alertas_umbrales_codigo_key;
ALTER TABLE IF EXISTS ONLY public.alertas DROP CONSTRAINT IF EXISTS alertas_pkey;
ALTER TABLE IF EXISTS public.datos_metereologicos ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.audit_log ALTER COLUMN id DROP DEFAULT;
DROP TABLE IF EXISTS public.zonas;
DROP VIEW IF EXISTS public.v_vacas_en_retirada;
DROP VIEW IF EXISTS public.v_tratamientos_pendientes;
DROP VIEW IF EXISTS public.v_produccion_diaria;
DROP TABLE IF EXISTS public.usuarios;
DROP TABLE IF EXISTS public.turnos;
DROP TABLE IF EXISTS public.tratamientos_activos;
DROP TABLE IF EXISTS public.tareas_recurrentes;
DROP TABLE IF EXISTS public.tareas_ejecuciones;
DROP TABLE IF EXISTS public.tareas_catalogo;
DROP TABLE IF EXISTS public.schema_migrations;
DROP TABLE IF EXISTS public.resumenes_relevo;
DROP TABLE IF EXISTS public.pedidos;
DROP TABLE IF EXISTS public.maquinaria;
DROP TABLE IF EXISTS public.lecturas_robot_ordeno;
DROP TABLE IF EXISTS public.lecturas_meteorologia;
DROP TABLE IF EXISTS public.lecturas_carro_mezclador;
DROP TABLE IF EXISTS public.lactaciones;
DROP TABLE IF EXISTS public.incidencias;
DROP TABLE IF EXISTS public.genomica;
DROP TABLE IF EXISTS public.eventos_sanitarios_recria;
...
DROP SEQUENCE IF EXISTS public.datos_metereologicos_id_seq;
DROP TABLE IF EXISTS public.datos_metereologicos;
DROP TABLE IF EXISTS public.core_zones;
DROP TABLE IF EXISTS public.core_treatments;
DROP TABLE IF EXISTS public.core_tasks;
DROP TABLE IF EXISTS public.core_machinery;
DROP TABLE IF EXISTS public.core_lactations;
DROP TABLE IF EXISTS public.core_incidents;
DROP TABLE IF EXISTS public.core_employees;
DROP TABLE IF EXISTS public.core_animals;
DROP TABLE IF EXISTS public.core_alerts;
DROP TABLE IF EXISTS public.boxes_recria;
...
DROP TABLE IF EXISTS public.alertas_umbrales;
DROP TABLE IF EXISTS public.alertas;
DROP FUNCTION IF EXISTS public.fn_audit_trigger();
DROP TYPE IF EXISTS public.tipo_turno;
DROP TYPE IF EXISTS public.tipo_patologia;
DROP TYPE IF EXISTS public.tipo_maquinaria;
DROP TYPE IF EXISTS public.tipo_incidencia;
DROP TYPE IF EXISTS public.tipo_evento_repro;
DROP TYPE IF EXISTS public.sexo_animal;
DROP TYPE IF EXISTS public.rol_empleado;
DROP TYPE IF EXISTS public.nivel_severidad;
DROP TYPE IF EXISTS public.nivel_alerta;
DROP TYPE IF EXISTS public.estado_tarea;
DROP TYPE IF EXISTS public.estado_reproductivo;
DROP TYPE IF EXISTS public.estado_pedido;
DROP TYPE IF EXISTS public.estado_incidencia;
DROP TYPE IF EXISTS public.estado_animal;
...
\unrestrict wbzMoFLIsJzR6wJi9R8mybmsVKBElHxyW5SF0jsf1PbUfiEB2qEzYEccb9VXeDO
